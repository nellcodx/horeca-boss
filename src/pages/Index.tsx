...
import { Users, Utensils, LogIn, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-4xl grid grid-cols-1 sm:grid-cols-3 gap-5">
        ...
        <motion.button
          ...
          className="group relative overflow-hidden p-7 rounded-2xl border-2 border-border bg-card hover:border-primary hover:shadow-xl hover:shadow-primary/10 transition-all duration-300 text-left"
        >
          ...
          <h2 className="font-heading font-bold text-xl text-card-foreground mb-2">Зона клієнта</h2>
        ...
        >
          ...
          <h2 className="font-heading font-bold text-xl text-card-foreground mb-2">Зона персоналу</h2>
        ...
        >
          ...
          <h2 className="font-heading font-bold text-xl text-card-foreground mb-2">Авторизація</h2>
          <p className="text-sm text-muted-foreground mb-4">Вхід або реєстрація в системі</p>
          <div className="flex items-center gap-2 text-primary font-semibold text-sm">
            <span>Увійти</span>
            <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
          </div>
